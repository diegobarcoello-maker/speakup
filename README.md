...
| **Lecciones** | 22 unidades (4 de A1, 5 de A2, 7 de B1, 6 de B2) que cubren el temario completo de A1 a B2. Cada una trae un punto de gramática explicado a fondo en español, 1-2 puntos adicionales, una tabla de errores típicos del hispanohablante, **57 a 80 palabras de vocabulario** con audio (una lista base más una ampliada), y la cantidad y la dificultad suben con el nivel: 58 de media en A1, 66 en A2, 71 en B1 y 78 en B2. Más 12 frases útiles y 11-12 ejercicios de 5 tipos. |
| **Vocabulario** | **36 packs con 1.765 palabras**, en dos bloques. **Las esenciales** (14 packs, 727 palabras) no van por tema sino por frecuencia: los verbos, sustantivos, adjetivos, adverbios, preposiciones y conectores que más aparecen al hablar y escribir, más **los 100 verbos irregulares con sus tres formas** y las palabras cortas que se cuelan en todas las frases. **Los temáticos** (22 packs, 1.038 palabras) cubren la vida diaria: personas y familia, la casa, comida, el cuerpo y la salud, ropa y compras, la ciudad, el tiempo y las fechas, la rutina, transporte, clima, emociones, trabajo, dinero, tecnología, ocio, viaje y restaurante, expresiones cotidianas, phrasal verbs y comercio exterior. Cada palabra con traducción, **frase de ejemplo en inglés y español**, y audio de la frase completa. Un botón manda el pack entero al repaso espaciado, y una prueba rápida de 10 preguntas mide cuánto se te quedó. |
...
| **Escuchar · Diálogos** | 28 diálogos de 8 a 12 turnos, leídos por **dos voces distintas** a velocidad normal (o despacio). Se escuchan **sin texto**: primero respondes preguntas de comprensión, luego escribes una frase al dictado, y solo entonces se abre la transcripción con traducción y audio por turno. Leer mientras oyes no entrena el oído, así que la app no te deja. |
| **Prueba de nivel** | 24 preguntas de dificultad creciente, seis por nivel, que sitúan a la persona en A1, A2, B1 o B2 y le ajustan el punto de partida. Se ofrece al empezar y está siempre en la Guía. |
| **Recordatorio diario** | Aviso a la hora que elijas. Notificación del navegador donde funciona, y descarga de un evento de calendario recurrente como método fiable en cualquier teléfono. |
| **Guía** | Un recorrido de nueve tarjetas con icono, titular y dos líneas, con sonido suave sintetizado por el propio navegador. Más «Primeros pasos»: seis misiones que se marcan solas al usar la app de verdad. |
| **Escuchar · Pronunciar** | Escuchas la frase nativa (normal o despacio), la dices con tu voz y recibes un puntaje que marca en verde y rojo qué palabras salieron bien. |
| **Escuchar · Sonidos** | 8 sonidos que el español no tiene o confunde, con 48 **pares mínimos**: *sheep/ship*, *berry/very*, *think/sink*, *ship/chip*, *hair/air*, *bad/bed*, la *s* inicial de *speak* y las tres pronunciaciones de *-ed*. Cada uno explica qué pasa en tu boca y te da el truco. Luego te pide decir una de las dos palabras al azar: si el micrófono entiende la otra, no las estás distinguiendo. |
...
| **Asistente flotante** | Un botón siempre a mano para resolver cualquier duda. Sabe en qué pantalla estás, qué unidad tienes abierta, en qué ejercicio vas y qué errores repites — así que puedes preguntarle *"¿por qué es esa la correcta?"* sin explicarle nada. También responde dudas sobre la propia app. |
...
En total: **3.585 entradas y 1.859 palabras sueltas distintas** (1.546 en las lecciones, 727 en los packs esenciales y 1.038 en los temáticos), 264 frases, 250 ejercicios, 110 errores típicos documentados y unos 47.000 caracteres de explicación gramatical en español. Las lecciones dan 3.160 XP, así que la ruta hasta B2 cierra con el contenido incluido, sin depender de nada externo.

El vocabulario se eligió midiendo, no a ojo: se contrastó contra una lista de las 514 palabras más frecuentes del inglés, y hoy **el 100% de las palabras de contenido de esa lista se enseña explícitamente** (el resto son artículos, auxiliares y preposiciones, que se aprenden en la gramática, no como vocabulario suelto).

Y está deliberadamente repartido entre dos mundos: el del trabajo —cotización, orden de compra, Incoterms, negociación— y el de la vida diaria —la cocina, el médico, el clima, la familia—, porque hablar inglés de verdad no es solo aguantar una reunión de ventas.
