...
/* ══════════════════ A1 ══════════════════ */
{
  ...
  vocabPlus: [
    ...
    { en: "Hey", es: "Hola (informal)" },
    { en: "What is up?", es: "¿Qué tal?" },
    { en: "How are things?", es: "¿Cómo van las cosas?" },
    { en: "How is everything?", es: "¿Cómo va todo?" },
    { en: "Long time no see", es: "Hace tiempo que no te veo" },
    { en: "Come in", es: "Pase / entra" },
    { en: "Have a seat", es: "Tome asiento" },
    { en: "May I introduce...", es: "Permítame presentarle a..." },
    { en: "This is my colleague", es: "Este es mi colega" },
    { en: "We have met before", es: "Ya nos conocíamos" },
    { en: "Likewise", es: "Igualmente" },
    { en: "The pleasure is mine", es: "El placer es mío" },
    { en: "How do you do?", es: "¿Cómo está usted? (formal)" },
    { en: "Sorry to bother you", es: "Perdón por molestar" },
    { en: "No problem", es: "No hay problema" },
    { en: "Do not worry", es: "No se preocupe" },
    { en: "Say hello to...", es: "Saluda a..." },
    { en: "Give my regards to...", es: "Dale mis saludos a..." },
    ...
    { en: "Cheers", es: "Salud (brindis)" },
    { en: "Nice to see you", es: "Qué gusto verte" },
    { en: "How have you been?", es: "¿Cómo has estado?" },
    { en: "Fine, thanks", es: "Bien, gracias" },
    { en: "Pleased to meet you", es: "Un placer conocerte" },
    { en: "My name is", es: "Me llamo" },
    { en: "Call me Diego", es: "Dime Diego" },
    { en: "Nice talking to you", es: "Un gusto hablar contigo" }
  ],
  phrases: [
...

{
  ...
  vocabPlus: [
    { en: "Where are you from?", es: "¿De dónde eres?" },
    { en: "I am from Ecuador", es: "Soy de Ecuador" },
    { en: "nationality", es: "nacionalidad" },
    { en: "mother tongue", es: "lengua materna" },
    { en: "I speak Spanish", es: "Hablo español" },
    { en: "a little English", es: "un poco de inglés" },
    { en: "How old are you?", es: "¿Cuántos años tienes?" },
    { en: "I am forty", es: "Tengo cuarenta" },
    { en: "Where do you live?", es: "¿Dónde vives?" },
    { en: "I live in Cuenca", es: "Vivo en Cuenca" },
    { en: "What do you do?", es: "¿A qué te dedicas?" },
    { en: "I work in sales", es: "Trabajo en ventas" },
    { en: "Could you repeat that?", es: "¿Puede repetir?" },
    { en: "Slowly, please", es: "Más despacio, por favor" },
    { en: "How do you spell it?", es: "¿Cómo se escribe?" },
    { en: "Let me write it down", es: "Déjame anotarlo" },
    { en: "I have two kids", es: "Tengo dos hijos" },
    { en: "ID card", es: "cédula" },
    { en: "date of birth", es: "fecha de nacimiento" },
    { en: "address", es: "dirección" },
    { en: "surname", es: "apellido" },
    { en: "zip code", es: "código postal" },
    { en: "occupation", es: "ocupación" },
    { en: "workplace", es: "lugar de trabajo" },
    { en: "I am an engineer", es: "Soy ingeniero" },
    { en: "I study", es: "estudio" },
    { en: "I am retired", es: "estoy jubilado" },
    { en: "Are you from here?", es: "¿Eres de aquí?" },
    { en: "I have lived here for", es: "llevo viviendo aquí" }
  ],
  phrases: [
...

{
  ...
  vocabPlus: [
    ...
    { en: "one thousand", es: "mil" },
    { en: "a million", es: "un millón" },
    { en: "first", es: "primero" },
    { en: "second", es: "segundo (orden)" },
    { en: "third", es: "tercero" },
    { en: "half", es: "mitad" },
    { en: "a quarter", es: "un cuarto" },
    { en: "double", es: "doble" },
    { en: "What time is it?", es: "¿Qué hora es?" },
    { en: "at noon", es: "al mediodía" },
    { en: "at midnight", es: "a medianoche" },
    { en: "a.m.", es: "de la mañana" },
    { en: "p.m.", es: "de la tarde/noche" },
    { en: "next week", es: "la próxima semana" },
    { en: "in two days", es: "en dos días" },
    { en: "every Monday", es: "todos los lunes" },
...

{
  ...
  vocabPlus: [
    ...
    { en: "one of my", es: "uno de mis" },
    { en: "a friend of mine", es: "un amigo mío" },
    { en: "somebody else", es: "alguien más" },
    { en: "nothing", es: "nada" },
    ...
    { en: "no one", es: "nadie" },
    { en: "each other", es: "el uno al otro" },
    { en: "myself", es: "yo mismo" },
    { en: "yourself", es: "tú mismo" },
    { en: "himself", es: "él mismo" },
    { en: "themselves", es: "ellos mismos" },
    { en: "whose is it?", es: "¿de quién es?" },
    { en: "It belongs to me", es: "Me pertenece" },
    { en: "feet", es: "pies" }
  ],
  phrases: [
    { en: "This is the client's order.", es: 'Este es el pedido del cliente.' },
...
/* ══════════════════ A2 ══════════════════ */
{
  ...
  vocabPlus: [
    ...
    { en: "do you...?", es: "¿tú...?" },
    { en: "does he...?", es: "¿él...?" },
    { en: "I do not", es: "yo no" },
    { en: "he does not", es: "él no" },
    { en: "three times a month", es: "tres veces al mes" },
    { en: "hardly ever", es: "casi nunca" },
    { en: "from time to time", es: "de vez en cuando" },
    { en: "on weekdays", es: "los días de semana" },
    { en: "after work", es: "después del trabajo" },
    { en: "before breakfast", es: "antes del desayuno" },
    { en: "during the day", es: "durante el día" },
    { en: "all day long", es: "todo el día" },
    { en: "in the meantime", es: "mientras tanto" },
    { en: "as usual", es: "como siempre" },
    { en: "at the same time", es: "al mismo tiempo" },
    { en: "right after", es: "justo después" },
    { en: "I am used to it", es: "estoy acostumbrado" },
    { en: "It depends on the day", es: "Depende del día" },
    { en: "a typical day", es: "un día típico" },
    { en: "my schedule", es: "mi horario" },
    { en: "I try to", es: "trato de" },
    { en: "I need to", es: "necesito" },
    { en: "I have to", es: "tengo que" },
    { en: "I want to", es: "quiero" },
    { en: "get ready for work", es: "alistarse para el trabajo" },
    { en: "commute", es: "trasladarse al trabajo" },
    { en: "run errands", es: "hacer diligencias" },
    { en: "pick up the kids", es: "recoger a los niños" },
    { en: "drop by", es: "pasar un momento" },
    { en: "grab a coffee", es: "tomar un café rápido" },
    { en: "stay late", es: "quedarse hasta tarde" },
    { en: "log the visits", es: "registrar las visitas" },
    { en: "plan the route", es: "planificar la ruta" },
    { en: "wrap up", es: "cerrar / terminar" },
    { en: "unwind", es: "desconectar" },
    { en: "stick to a routine", es: "apegarse a una rutina" },
    { en: "skip breakfast", es: "saltarse el desayuno" }
  ],
  phrases: [
    { en: "I usually start work at eight.", es: 'Normalmente empiezo a trabajar a las ocho.' },
...

{
  ...
  vocabPlus: [
    { en: "place an order", es: "hacer un pedido" },
    { en: "confirm an order", es: "confirmar un pedido" },
    { en: "cancel an order", es: "cancelar un pedido" },
    { en: "order number", es: "número de pedido" },
    { en: "box", es: "caja" },
    { en: "catalog", es: "catálogo" },
    { en: "shipping", es: "envío" },
    ...
    { en: "transfer a call", es: "transferir una llamada" },
    { en: "leave a message", es: "dejar un mensaje" },
    { en: "take a note", es: "tomar nota" },
    { en: "check the system", es: "revisar el sistema" },
    { en: "I will look into it", es: "lo voy a revisar" },
    { en: "Let me confirm", es: "déjeme confirmar" },
    { en: "right away", es: "de inmediato" },
    { en: "quote a price", es: "cotizar un precio" },
    { en: "back order", es: "pedido pendiente" },
    { en: "restock", es: "reabastecer" },
    { en: "dispatch", es: "despachar" },
    { en: "tracking number", es: "número de guía" },
    { en: "partial delivery", es: "entrega parcial" },
    { en: "credit note", es: "nota de crédito" },
    { en: "purchase", es: "compra" },
    { en: "supplier code", es: "código de proveedor" },
    { en: "SKU", es: "código de producto" },
    { en: "inventory", es: "inventario" },
    { en: "shortage", es: "faltante" },
    { en: "surplus", es: "excedente" },
    { en: "reorder", es: "volver a pedir" },
    { en: "confirm receipt", es: "confirmar recepción" },
    { en: "acknowledge", es: "acusar recibo" },
...

{
  ...
  vocabPlus: [
    ...
    { en: "more expensive than", es: "más caro que" },
    { en: "better than", es: "mejor que" },
    { en: "worse than", es: "peor que" },
    { en: "the cheapest", es: "el más barato" },
    { en: "as good as", es: "tan bueno como" },
    { en: "not as cheap as", es: "no tan barato como" },
    { en: "the same as", es: "igual que" },
    { en: "similar to", es: "parecido a" },
    { en: "different from", es: "diferente de" },
    { en: "twice as much", es: "el doble" },
    { en: "much more", es: "mucho más" },
    { en: "a bit less", es: "un poco menos" },
    { en: "by far", es: "por mucho" },
    { en: "height", es: "altura" },
    { en: "width", es: "ancho" },
    { en: "length", es: "largo" },
    { en: "durable", es: "duradero" },
    { en: "lightweight", es: "ligero" },
    { en: "waterproof", es: "impermeable" },
    { en: "drawback", es: "desventaja" },
    { en: "finish (surface)", es: "acabado" },
    { en: "texture", es: "textura" },
    { en: "capacity", es: "capacidad" },
    { en: "range", es: "gama" },
    { en: "version", es: "versión" },
    { en: "specification", es: "especificación" },
    { en: "standard", es: "estándar" },
    { en: "certified", es: "certificado" },
    { en: "sturdy", es: "robusto" },
    { en: "flimsy", es: "endeble" },
    { en: "outdated", es: "desactualizado" },
    { en: "state of the art", es: "de última generación" }
  ],
  phrases: [
...

{
  ...
  vocabPlus: [
    { en: "book a flight", es: "reservar un vuelo" },
    { en: "one-way", es: "solo ida" },
    { en: "round trip", es: "ida y vuelta" },
    { en: "layover", es: "escala" },
    { en: "boarding time", es: "hora de embarque" },
    { en: "terminal", es: "terminal" },
    { en: "check in online", es: "registrarse en línea" },
    { en: "excess baggage", es: "exceso de equipaje" },
    { en: "security check", es: "control de seguridad" },
    { en: "duty free", es: "libre de impuestos" },
    { en: "rent a car", es: "alquilar un carro" },
    { en: "driver license", es: "licencia de conducir" },
    { en: "single room", es: "habitación simple" },
    { en: "receipt for expenses", es: "recibo de gastos" },
    { en: "expense report", es: "informe de gastos" },
    { en: "per diem", es: "viáticos" },
    { en: "booth", es: "stand" },
    { en: "appointment", es: "cita" },
    { en: "itinerary", es: "itinerario" },
    { en: "jet lag", es: "desfase por horario" },
    { en: "travel insurance", es: "seguro de viaje" },
    { en: "I am here for business", es: "Vengo por negocios" },
    { en: "depart", es: "partir" },
    { en: "board", es: "abordar" },
    { en: "aisle", es: "pasillo" },
    { en: "overhead bin", es: "compartimento superior" },
    { en: "customs form", es: "formulario de aduana" },
    { en: "shuttle", es: "transporte de enlace" },
    { en: "amenities", es: "servicios del hotel" },
    { en: "conference room", es: "sala de conferencias" },
    { en: "networking", es: "hacer contactos" },
    { en: "exhibitor", es: "expositor" },
    { en: "badge", es: "credencial" },
    { en: "reimbursement", es: "reembolso de gastos" },
    { en: "allowance", es: "asignación" }
  ],
  phrases: [
...

{
  ...
  vocabPlus: [
    ...
    { en: "a lot", es: "mucho" },
    { en: "plenty of", es: "bastante" },
    { en: "too many", es: "demasiados" },
    { en: "none", es: "ninguno" },
    { en: "all", es: "todo" },
    { en: "most", es: "la mayoría" },
    { en: "half of", es: "la mitad de" },
    { en: "a bottle of", es: "una botella de" },
    { en: "a cup of", es: "una taza de" },
    { en: "a bag of", es: "una bolsa de" },
    { en: "a pair of", es: "un par de" },
    { en: "a kilo of", es: "un kilo de" },
    { en: "a liter of", es: "un litro de" },
    { en: "a couple of", es: "un par de" },
    { en: "several", es: "varios" },
    { en: "each", es: "cada uno" },
    { en: "both", es: "ambos" },
    { en: "either", es: "cualquiera de los dos" },
    { en: "neither", es: "ninguno de los dos" },
    { en: "a dozen", es: "una docena" },
    { en: "a handful of", es: "un puñado de" },
    { en: "a great deal of", es: "una gran cantidad de" },
    { en: "the rest of", es: "el resto de" },
    { en: "a portion", es: "una porción" },
    { en: "a slice of", es: "una rebanada de" },
    { en: "a jar of", es: "un frasco de" },
    { en: "a can of", es: "una lata de" },
    { en: "a sheet of", es: "una hoja de" },
    { en: "a set of", es: "un juego de" },
    { en: "scarce", es: "escaso" },
    { en: "abundant", es: "abundante" },
    { en: "approximately", es: "aproximadamente" },
    { en: "roughly", es: "aproximadamente" },
    { en: "at most", es: "como máximo" }
  ],
  phrases: [
    { en: "How many units do you need?", es: '¿Cuántas unidades necesita?' },
...
/* ══════════════════ B1 ══════════════════ */
{
  ...
  vocabPlus: [
    ...
    { en: "back then", es: "en ese entonces" },
    { en: "at that time", es: "en ese momento" },
    { en: "when I was young", es: "cuando era joven" },
    { en: "I went", es: "fui" },
    { en: "I saw", es: "vi" },
    { en: "I did", es: "hice" },
    { en: "I said", es: "dije" },
    { en: "I told him", es: "le dije" },
    { en: "I bought", es: "compré" },
    { en: "I sold", es: "vendí" },
    { en: "I sent", es: "envié" },
    { en: "I got", es: "conseguí" },
    { en: "I made", es: "hice" },
    { en: "I took", es: "tomé" },
    { en: "I met", es: "conocí" },
    { en: "I found", es: "encontré" },
    { en: "I lost", es: "perdí" },
    { en: "I left", es: "me fui / dejé" },
    { en: "I began", es: "empecé" },
    { en: "I brought", es: "traje" },
    { en: "as soon as", es: "tan pronto como" },
    { en: "by the time", es: "cuando ya" },
    { en: "It happened", es: "Ocurrió" },
    { en: "I spent", es: "pasé / gasté" },
    { en: "I grew up", es: "crecí" },
    { en: "I quit", es: "renuncié / dejé" },
    { en: "I hired", es: "contraté" },
    { en: "I managed", es: "gestioné / logré" },
    { en: "I dealt with", es: "me encargué de" },
    { en: "I built", es: "construí" },
    { en: "I chose", es: "elegí" },
    { en: "I kept", es: "mantuve" },
    { en: "I put together", es: "armé" },
    { en: "I ran into", es: "me topé con" },
    { en: "back in 2018", es: "allá por 2018" },
    { en: "eventually", es: "con el tiempo" },
    { en: "meanwhile", es: "mientras tanto" },
    { en: "shortly after", es: "poco después" },
    { en: "It turned out", es: "resultó que" }
  ],
  phrases: [
    { en: "I met the client last Tuesday.", es: 'Me reuní con el cliente el martes pasado.' },
...

{
  ...
  vocabPlus: [
    ...
    { en: "I will", es: "voy a / lo haré" },
    { en: "I plan to", es: "planeo" },
    { en: "I intend to", es: "tengo la intención de" },
    { en: "I am thinking of", es: "estoy pensando en" },
    { en: "I hope to", es: "espero" },
    { en: "I expect to", es: "espero (con base)" },
    { en: "most likely", es: "lo más probable" },
    { en: "for sure", es: "con seguridad" },
    { en: "maybe", es: "tal vez" },
    { en: "It is up in the air", es: "está en el aire" },
    { en: "by the end of the month", es: "para fin de mes" },
    { en: "within two weeks", es: "en dos semanas" },
    { en: "in the long run", es: "a la larga" },
    { en: "in the short term", es: "a corto plazo" },
    { en: "sooner or later", es: "tarde o temprano" },
    { en: "as planned", es: "según lo planeado" },
    { en: "ahead of schedule", es: "antes de lo previsto" },
    { en: "behind schedule", es: "atrasado" },
    { en: "reschedule", es: "reprogramar" },
    { en: "postpone", es: "postergar" },
    { en: "confirm the date", es: "confirmar la fecha" },
    { en: "set a goal", es: "fijar una meta" },
    { en: "make a plan", es: "armar un plan" },
    { en: "keep you posted", es: "te mantengo informado" },
    { en: "I am due to", es: "me toca" },
    { en: "I am about to", es: "estoy por" },
    { en: "on the verge of", es: "a punto de" },
    { en: "in the pipeline", es: "en camino" },
    { en: "forthcoming", es: "venidero" },
    { en: "tentative", es: "tentativo" },
    { en: "provisional", es: "provisional" },
    { en: "milestone", es: "hito" },
    { en: "target date", es: "fecha objetivo" },
    { en: "kick off", es: "arrancar" },
    { en: "follow through", es: "llevar hasta el final" },
    { en: "contingency", es: "plan de contingencia" },
    { en: "anticipate", es: "anticipar" },
    { en: "foresee", es: "prever" },
    { en: "bear in mind", es: "tener presente" },
    { en: "lock in a date", es: "fijar una fecha" },
    { en: "firm up", es: "concretar" }
  ],
  phrases: [
    { en: "I'm going to visit the client on Monday.", es: 'Voy a visitar al cliente el lunes.' },
...

{
  ...
  vocabPlus: [
    ...
    { en: "several times", es: "varias veces" },
    { en: "It has changed", es: "ha cambiado" },
    { en: "It has improved", es: "ha mejorado" },
    { en: "We have grown", es: "hemos crecido" },
    { en: "I have worked here", es: "he trabajado aquí" },
    { en: "I have not received it", es: "no lo he recibido" },
    { en: "Has it shipped?", es: "¿Ya se envió?" },
    { en: "It has come up", es: "ha surgido" },
    { en: "I have dealt with", es: "he manejado" },
    { en: "I have grown", es: "he crecido" },
    { en: "I have handled", es: "he gestionado" },
    { en: "I have applied", es: "he postulado" },
    { en: "It has been resolved", es: "se ha resuelto" },
    { en: "We have doubled", es: "hemos duplicado" },
    { en: "It has dropped", es: "ha bajado" },
    { en: "It has picked up", es: "ha repuntado" },
    { en: "outstanding", es: "pendiente / sobresaliente" },
    { en: "ongoing", es: "en curso" },
    { en: "to date", es: "hasta la fecha" },
    { en: "as of today", es: "a día de hoy" },
    { en: "over the past year", es: "en el último año" },
    { en: "ever since", es: "desde entonces" },
    { en: "by now", es: "a estas alturas" },
    { en: "at this point", es: "a este punto" },
    { en: "long-standing", es: "de larga data" },
    { en: "turnaround", es: "giro / recuperación" },
    { en: "breakthrough", es: "avance importante" },
    { en: "setback", es: "revés" },
    { en: "progress so far", es: "avance hasta ahora" }
  ],
  phrases: [
...

{
  ...
  vocabPlus: [
    ...
    { en: "I believe", es: "considero que" },
    { en: "In my view", es: "a mi ver" },
    { en: "If you ask me", es: "si me preguntas" },
    { en: "It seems to me", es: "me parece" },
    { en: "From my point of view", es: "desde mi punto de vista" },
    { en: "I would say", es: "yo diría" },
    { en: "I agree", es: "estoy de acuerdo" },
    { en: "I totally agree", es: "estoy totalmente de acuerdo" },
    { en: "I see your point", es: "entiendo tu punto" },
    { en: "You have a point", es: "tienes razón en algo" },
    { en: "I am afraid I disagree", es: "me temo que no coincido" },
    { en: "I do not think so", es: "no lo creo" },
    { en: "Not necessarily", es: "no necesariamente" },
    { en: "On the contrary", es: "al contrario" },
    { en: "That said", es: "dicho eso" },
    { en: "To be fair", es: "para ser justos" },
    { en: "Let us agree to disagree", es: "quedemos en desacuerdo" },
    { en: "What do you think?", es: "¿Qué opinas?" },
    { en: "How do you see it?", es: "¿Cómo lo ves?" },
    { en: "Any thoughts?", es: "¿Alguna idea?" },
    { en: "I am open to it", es: "estoy abierto a eso" },
    { en: "It makes sense", es: "tiene sentido" },
    { en: "That is a good point", es: "ese es un buen punto" },
    { en: "honestly", es: "honestamente" },
    { en: "frankly", es: "francamente" },
    { en: "I would argue", es: "yo argumentaría" },
    { en: "I am inclined to think", es: "me inclino a pensar" },
    { en: "It strikes me that", es: "me da la impresión de que" },
    { en: "as far as I am concerned", es: "en lo que a mí respecta" },
    { en: "correct me if I am wrong", es: "corrígeme si me equivoco" },
    { en: "with all due respect", es: "con todo respeto" },
    { en: "I take your point", es: "acepto tu punto" },
    { en: "I beg to differ", es: "discrepo" },
    { en: "I am torn", es: "estoy dividido" },
    { en: "It is debatable", es: "es discutible" },
    { en: "It is questionable", es: "es cuestionable" },
    { en: "reasonable", es: "razonable" },
    { en: "valid", es: "válido" },
    { en: "biased", es: "sesgado" },
    { en: "objective", es: "objetivo" },
    { en: "argument", es: "argumento" },
    { en: "common ground", es: "punto en común" }
  ],
  phrases: [
...

{
  ...
  vocabPlus: [
    { en: "must not", es: "no se debe (prohibido)" },
    { en: "do not have to", es: "no es necesario" },
    { en: "should not", es: "no debería" },
    { en: "ought to", es: "debería" },
    { en: "need to", es: "necesitar" },
    { en: "be supposed to", es: "se supone que" },
    { en: "be allowed to", es: "tener permiso de" },
    { en: "be required to", es: "estar obligado a" },
    { en: "It is mandatory", es: "es obligatorio" },
    { en: "It is forbidden", es: "está prohibido" },
    { en: "It is optional", es: "es opcional" },
    { en: "permission", es: "permiso" },
    { en: "My advice is", es: "mi consejo es" },
    { en: "If I were you", es: "si yo fuera tú" },
    { en: "You might want to", es: "podrías" },
    { en: "It would be better to", es: "sería mejor" },
    { en: "Make sure you", es: "asegúrate de" },
    { en: "Do not forget to", es: "no olvides" },
    { en: "Be careful with", es: "ten cuidado con" },
    { en: "I recommend", es: "recomiendo" },
    { en: "It is up to you", es: "tú decides" },
    { en: "be entitled to", es: "tener derecho a" },
    { en: "be liable for", es: "ser responsable de" },
    { en: "comply with", es: "cumplir con" },
    { en: "enforce", es: "hacer cumplir" },
    { en: "waive", es: "renunciar a / eximir" },
    { en: "exempt", es: "exento" },
    { en: "restricted", es: "restringido" },
    { en: "prohibited", es: "prohibido" },
    { en: "authorized", es: "autorizado" },
    { en: "guidelines", es: "lineamientos" },
    { en: "protocol", es: "protocolo" },
    { en: "breach", es: "incumplimiento" },
    { en: "warning", es: "advertencia" },
    { en: "It is advisable to", es: "es aconsejable" },
    { en: "you are supposed to", es: "se supone que debes" },
    { en: "there is no need to", es: "no hace falta" },
    { en: "I would strongly suggest", es: "sugiero encarecidamente" },
    { en: "Under no circumstances", es: "bajo ninguna circunstancia" },
    { en: "as a last resort", es: "como último recurso" }
  ],
  phrases: [
    { en: "I have to send the report every Monday.", es: 'Tengo que enviar el informe cada lunes.' },
...

{
  ...
  vocabPlus: [
    { en: "enjoy doing", es: "disfrutar hacer" },
    { en: "avoid doing", es: "evitar hacer" },
    { en: "finish doing", es: "terminar de hacer" },
    { en: "keep doing", es: "seguir haciendo" },
    { en: "mind doing", es: "importar hacer" },
    { en: "suggest doing", es: "sugerir hacer" },
    { en: "consider doing", es: "considerar hacer" },
    { en: "look forward to doing", es: "esperar con gusto hacer" },
    { en: "be good at doing", es: "ser bueno haciendo" },
    { en: "be interested in doing", es: "estar interesado en hacer" },
    { en: "instead of doing", es: "en vez de hacer" },
    { en: "before doing", es: "antes de hacer" },
    { en: "after doing", es: "después de hacer" },
    { en: "decide to do", es: "decidir hacer" },
    { en: "agree to do", es: "aceptar hacer" },
    { en: "offer to do", es: "ofrecerse a hacer" },
    { en: "refuse to do", es: "negarse a hacer" },
    { en: "promise to do", es: "prometer hacer" },
    { en: "manage to do", es: "lograr hacer" },
    { en: "afford to do", es: "poder costear hacer" },
    { en: "learn to do", es: "aprender a hacer" },
    { en: "forget to do", es: "olvidar hacer" },
    { en: "try to do", es: "intentar hacer" },
    { en: "need to do", es: "necesitar hacer" },
    { en: "want to do", es: "querer hacer" },
    { en: "would like to do", es: "gustaría hacer" },
    { en: "stop doing", es: "dejar de hacer" },
    { en: "stop to do", es: "parar para hacer" },
    { en: "be worth doing", es: "valer la pena hacer" },
    { en: "cannot help doing", es: "no poder evitar hacer" },
    { en: "be tired of doing", es: "estar harto de hacer" },
    { en: "insist on doing", es: "insistir en hacer" },
    { en: "succeed in doing", es: "lograr hacer" },
    { en: "end up doing", es: "terminar haciendo" },
    { en: "give up doing", es: "dejar de hacer" },
    { en: "be about to do", es: "estar por hacer" },
    { en: "happen to do", es: "dar la casualidad de hacer" },
    { en: "tend to do", es: "soler hacer" },
    { en: "fail to do", es: "no lograr hacer" },
    { en: "hesitate to do", es: "dudar en hacer" },
    { en: "bother to do", es: "molestarse en hacer" },
    { en: "be willing to do", es: "estar dispuesto a hacer" },
    { en: "be reluctant to do", es: "ser reacio a hacer" }
  ],
  phrases: [
    { en: "I want to place an order.", es: 'Quiero hacer un pedido.' },
    { en: "I enjoy working with that supplier.", es: 'Disfruto trabajando con ese proveedor.' },
...

{
  ...
  vocabPlus: [
    ...
    { en: "the company that", es: "la empresa que" },
    { en: "the client whose order", es: "el cliente cuyo pedido" },
    { en: "the place where", es: "el lugar donde" },
    { en: "the day when", es: "el día en que" },
    { en: "the reason why", es: "la razón por la que" },
    { en: "something that", es: "algo que" },
    { en: "anyone who", es: "cualquiera que" },
    { en: "everything we need", es: "todo lo que necesitamos" },
    { en: "the one I mean", es: "el que digo" },
    { en: "as far as", es: "en cuanto a" },
    { en: "in which case", es: "en cuyo caso" },
    { en: "the thing is", es: "la cosa es que" },
    { en: "what I mean is", es: "lo que quiero decir es" },
    ...
    { en: "the point at which", es: "el punto en el que" },
    { en: "the extent to which", es: "la medida en que" },
    { en: "in which", es: "en el cual" },
    { en: "for which", es: "por el cual" },
    { en: "to whom", es: "a quien" },
    { en: "with whom", es: "con quien" },
    { en: "none of which", es: "ninguno de los cuales" },
    { en: "both of whom", es: "ambos de los cuales" },
    { en: "all of which", es: "todo lo cual" },
    { en: "a case in point", es: "un ejemplo claro" },
    { en: "namely", es: "a saber" },
    { en: "that is to say", es: "es decir" },
    { en: "so-called", es: "así llamado" },
    { en: "aforementioned", es: "antes mencionado" },
    { en: "regarding", es: "respecto a" },
    { en: "concerning", es: "relativo a" },
    { en: "with respect to", es: "con respecto a" },
    { en: "as opposed to", es: "a diferencia de" },
    { en: "whereby", es: "mediante lo cual" },
...
/* ══════════════════ B2 ══════════════════ */
{
  ...
  vocabPlus: [
    ...
    { en: "If you order today", es: "si pides hoy" },
    { en: "we will ship tomorrow", es: "enviamos mañana" },
    { en: "I would accept", es: "yo aceptaría" },
    { en: "If we had known", es: "si hubiéramos sabido" },
    { en: "we would have called", es: "habríamos llamado" },
    { en: "could have", es: "podría haber" },
    { en: "should have", es: "debería haber" },
    { en: "would have", es: "habría" },
    { en: "might have", es: "podría haber" },
    { en: "assuming", es: "suponiendo" },
    { en: "suppose", es: "supongamos" },
    { en: "what if", es: "¿y si...?" },
    { en: "worst case", es: "en el peor caso" },
    { en: "best case", es: "en el mejor caso" },
    { en: "scenario", es: "escenario" },
    { en: "consequence", es: "consecuencia" },
    { en: "outcome", es: "resultado" },
    { en: "should you need", es: "si llegara a necesitar" },
    { en: "were it not for", es: "de no ser por" },
    { en: "had we known", es: "de haberlo sabido" },
    { en: "but for", es: "si no fuera por" },
    { en: "on condition that", es: "a condición de que" },
    { en: "in the event that", es: "en caso de que" },
    { en: "failing that", es: "en su defecto" },
    { en: "barring", es: "salvo" },
    { en: "all things being equal", es: "en igualdad de condiciones" },
    { en: "hypothetically", es: "hipotéticamente" },
    { en: "feasible", es: "viable" },
    { en: "inevitable", es: "inevitable" },
    { en: "contingent on", es: "condicionado a" },
    { en: "provided", es: "siempre que" },
    { en: "to mitigate", es: "mitigar" },
    { en: "to offset", es: "compensar" },
    { en: "fallback", es: "plan alternativo" },
    { en: "downside", es: "lado negativo" },
    { en: "upside", es: "lado positivo" },
    { en: "exposure", es: "exposición al riesgo" },
    { en: "prudent", es: "prudente" },
    { en: "warranted", es: "justificado" },
    { en: "a slim chance", es: "una posibilidad remota" },
    { en: "a safe bet", es: "una apuesta segura" },
    { en: "worst-case scenario", es: "el peor de los casos" },
    { en: "rule of thumb", es: "regla general" },
    { en: "trial and error", es: "ensayo y error" },
    { en: "a calculated risk", es: "un riesgo calculado" },
    { en: "to hedge", es: "cubrirse ante un riesgo" }
  ],
  phrases: [
...

{
  ...
  vocabPlus: [
    { en: "bring forward", es: "adelantar" },
    { en: "put back", es: "retrasar" },
    { en: "call in", es: "llamar / hacer venir" },
    { en: "check in with", es: "consultar con" },
    { en: "touch base", es: "ponerse en contacto" },
    { en: "reach out", es: "contactar" },
    { en: "draw up", es: "redactar" },
    { en: "lay out", es: "exponer / presentar" },
    { en: "map out", es: "planificar" },
    { en: "scale up", es: "escalar" },
    { en: "scale back", es: "reducir" },
    { en: "roll out", es: "implementar" },
    { en: "phase out", es: "descontinuar" },
    { en: "write off", es: "dar de baja" },
    { en: "break even", es: "alcanzar el punto de equilibrio" },
    { en: "bottom line", es: "lo esencial / resultado final" },
    { en: "ballpark figure", es: "cifra aproximada" },
    { en: "the big picture", es: "el panorama general" },
    { en: "cut corners", es: "hacer las cosas a medias" },
    { en: "go the extra mile", es: "hacer un esfuerzo extra" },
    { en: "touch and go", es: "en la cuerda floja" },
    { en: "off the top of my head", es: "así de memoria" },
    { en: "in the loop", es: "al tanto" },
    { en: "out of the loop", es: "desinformado" },
    { en: "down to the wire", es: "al límite del tiempo" },
    { en: "a win-win", es: "beneficio mutuo" },
    { en: "no-brainer", es: "decisión obvia" },
    { en: "iron out", es: "limar / resolver" },
    { en: "hammer out", es: "negociar hasta acordar" },
    { en: "flesh out", es: "desarrollar" },
    { en: "weigh in", es: "opinar" },
    { en: "chime in", es: "intervenir" },
    { en: "gloss over", es: "pasar por alto" },
    { en: "stem from", es: "derivarse de" },
    { en: "boil down to", es: "reducirse a" },
    { en: "account for", es: "explicar / representar" },
    { en: "rule out", es: "descartar" },
    { en: "factor in", es: "tener en cuenta" },
    { en: "bank on", es: "contar con" },
    { en: "cash in on", es: "sacar provecho de" },
    { en: "single out", es: "señalar / destacar" },
    { en: "level with", es: "ser franco con" },
    { en: "walk back", es: "retractarse de" },
    { en: "double down", es: "redoblar la apuesta" },
    { en: "drag on", es: "alargarse" },
    { en: "taper off", es: "disminuir gradualmente" },
    { en: "trickle down", es: "filtrarse hacia abajo" },
    { en: "a long shot", es: "muy poco probable" },
    { en: "par for the course", es: "lo habitual" },
    { en: "a game changer", es: "algo que lo cambia todo" },
    { en: "low-hanging fruit", es: "lo fácil de conseguir" },
    { en: "move the needle", es: "marcar la diferencia" }
  ],
  phrases: [
...

{
  ...
  vocabPlus: [
    { en: "open the meeting", es: "abrir la reunión" },
    { en: "set the agenda", es: "fijar la agenda" },
    { en: "walk you through", es: "explicarte paso a paso" },
    { en: "as you can see", es: "como pueden ver" },
    { en: "in conclusion", es: "en conclusión" },
    { en: "any questions?", es: "¿alguna pregunta?" },
    { en: "let me clarify", es: "déjeme aclarar" },
    { en: "bear with me", es: "tenga paciencia" },
    { en: "our proposal is", es: "nuestra propuesta es" },
    { en: "we can offer", es: "podemos ofrecer" },
    { en: "what we need is", es: "lo que necesitamos es" },
    { en: "meet halfway", es: "ceder ambos" },
    { en: "come down on price", es: "bajar el precio" },
    { en: "firm price", es: "precio firme" },
    { en: "final offer", es: "oferta final" },
    { en: "take it or leave it", es: "lo toma o lo deja" },
    { en: "room to negotiate", es: "margen para negociar" },
    { en: "under the circumstances", es: "dadas las circunstancias" },
    { en: "subject to approval", es: "sujeto a aprobación" },
    { en: "let us shake on it", es: "cerremos el trato" },
    { en: "sign off on", es: "dar el visto bueno" },
    { en: "back to the drawing board", es: "volver a empezar" },
    { en: "put it in writing", es: "ponerlo por escrito" },
    { en: "the ball is in your court", es: "la decisión es tuya" },
    { en: "we have a deal", es: "tenemos un trato" },
    { en: "concede", es: "conceder" },
    { en: "compromise", es: "ceder / acuerdo" },
    { en: "stipulate", es: "estipular" },
    { en: "clause", es: "cláusula" },
    { en: "addendum", es: "anexo" },
    { en: "non-binding", es: "no vinculante" },
    { en: "in good faith", es: "de buena fe" },
    { en: "mutually beneficial", es: "mutuamente beneficioso" },
    { en: "reciprocal", es: "recíproco" },
    { en: "contingency clause", es: "cláusula de contingencia" },
    { en: "escalate", es: "escalar" },
    { en: "defer", es: "aplazar" },
    { en: "reconcile", es: "conciliar" },
    { en: "substantiate", es: "sustentar" },
    { en: "a sticking point", es: "un punto de fricción" },
    { en: "give and take", es: "toma y daca" },
    { en: "bargaining power", es: "poder de negociación" },
    { en: "walk-away point", es: "punto de retirada" },
    { en: "anchor the price", es: "anclar el precio" },
    { en: "bundle", es: "agrupar en paquete" },
    { en: "unbundle", es: "desagrupar" },
    { en: "to reiterate", es: "reiterar" },
    { en: "the crux of it", es: "el meollo del asunto" }
  ],
  phrases: [
...

{
  ...
  vocabPlus: [
    ...
    { en: "my background", es: "mi trayectoria" },
    { en: "my strengths", es: "mis fortalezas" },
    { en: "my weakness", es: "mi debilidad" },
    { en: "I bring", es: "aporto" },
    { en: "I handled it by", es: "lo manejé así" },
    { en: "under pressure", es: "bajo presión" },
    { en: "team player", es: "buen compañero de equipo" },
    { en: "self-motivated", es: "automotivado" },
    { en: "detail-oriented", es: "detallista" },
    { en: "results-driven", es: "orientado a resultados" },
    { en: "willing to learn", es: "dispuesto a aprender" },
    { en: "Why this company?", es: "¿Por qué esta empresa?" },
    { en: "Where do you see yourself?", es: "¿Dónde te ves?" },
    { en: "salary expectations", es: "expectativa salarial" },
    { en: "notice period", es: "periodo de aviso" },
    { en: "available from", es: "disponible desde" },
    { en: "reference", es: "referencia" },
    { en: "follow-up email", es: "correo de seguimiento" },
    { en: "thank you note", es: "nota de agradecimiento" },
    { en: "I would argue that", es: "yo sostendría que" },
    { en: "the evidence shows", es: "la evidencia muestra" },
    { en: "on balance", es: "en balance" },
    { en: "to play devil advocate", es: "para hacer de abogado del diablo" },
    { en: "let me push back", es: "permíteme discrepar" },
    { en: "resilient", es: "resiliente" },
    { en: "adaptable", es: "adaptable" },
    { en: "meticulous", es: "meticuloso" },
    { en: "proactive", es: "proactivo" },
    { en: "pragmatic", es: "pragmático" },
    { en: "versatile", es: "versátil" },
    { en: "accountable", es: "responsable de rendir cuentas" },
    { en: "drive results", es: "impulsar resultados" },
    { en: "exceed expectations", es: "superar expectativas" },
    { en: "take ownership", es: "asumir la responsabilidad" },
    { en: "a steep learning curve", es: "una curva de aprendizaje pronunciada" },
    { en: "room for growth", es: "margen de crecimiento" },
    { en: "cross-functional", es: "interdisciplinario" },
    { en: "to mentor", es: "ser mentor de" },
    { en: "to advocate for", es: "abogar por" },
    { en: "to substantiate a claim", es: "fundamentar una afirmación" },
    { en: "compelling", es: "convincente" },
    { en: "flawed", es: "defectuoso" },
    { en: "nuanced", es: "matizado" },
    { en: "albeit", es: "aunque" },
    { en: "notwithstanding", es: "no obstante" },
    { en: "by and large", es: "en términos generales" },
    { en: "conversely", es: "por el contrario" }
  ],
  phrases: [
...

{
  ...
  vocabPlus: [
    { en: "is made", es: "se hace / es hecho" },
    { en: "was sent", es: "fue enviado" },
    { en: "has been shipped", es: "ha sido enviado" },
    { en: "will be delivered", es: "será entregado" },
    { en: "is being processed", es: "está siendo procesado" },
    { en: "was signed", es: "fue firmado" },
    { en: "is included", es: "está incluido" },
    { en: "is required", es: "es requerido" },
    { en: "is expected", es: "se espera" },
    { en: "is known as", es: "se conoce como" },
    { en: "was built", es: "fue construido" },
    { en: "is produced", es: "se produce" },
    { en: "is handled by", es: "es manejado por" },
    { en: "is issued", es: "se emite" },
    { en: "is approved", es: "está aprobado" },
    { en: "was rejected", es: "fue rechazado" },
    { en: "is charged", es: "se cobra" },
    { en: "is covered", es: "está cubierto" },
    { en: "by (agent)", es: "por (quien lo hace)" },
    { en: "It is said that", es: "se dice que" },
    { en: "It is believed that", es: "se cree que" },
    { en: "It has been reported", es: "se ha reportado" },
    { en: "It was agreed", es: "se acordó" },
    { en: "It should be noted", es: "cabe señalar" },
    { en: "It must be done", es: "debe hacerse" },
    { en: "process", es: "proceso" },
    { en: "regulation", es: "normativa" },
    { en: "is regulated", es: "está regulado" },
    { en: "is enforced", es: "se hace cumplir" },
    { en: "is audited", es: "es auditado" },
    { en: "is outsourced", es: "se terceriza" },
    { en: "is streamlined", es: "se simplifica" },
    { en: "is phased out", es: "se descontinúa" },
    { en: "is overseen by", es: "es supervisado por" },
    { en: "is subject to review", es: "está sujeto a revisión" },
    { en: "was overturned", es: "fue revocado" },
    { en: "was upheld", es: "fue ratificado" },
    { en: "was waived", es: "fue eximido" },
    { en: "is deemed", es: "se considera" },
    { en: "is presumed", es: "se presume" },
    { en: "is alleged", es: "se alega" },
    { en: "is attributed to", es: "se atribuye a" },
    { en: "is compiled", es: "se recopila" },
    { en: "is disclosed", es: "se divulga" },
    { en: "is withheld", es: "se retiene" },
    { en: "oversight", es: "supervisión" },
    { en: "accountability", es: "rendición de cuentas" },
    { en: "due diligence", es: "diligencia debida" }
  ],
  phrases: [
    { en: "The goods were shipped yesterday.", es: 'La mercancía fue enviada ayer.' },
    { en: "Your order has been processed.", es: 'Su pedido ha sido procesado.' },
...

{
  ...
  vocabPlus: [
    ...
    { en: "They mentioned", es: "Mencionaron" },
    { en: "He explained", es: "Explicó" },
    { en: "She confirmed", es: "Confirmó" },
    { en: "They asked if", es: "Preguntaron si" },
    { en: "He wanted to know", es: "Quería saber" },
    { en: "She suggested", es: "Sugirió" },
    { en: "They agreed to", es: "Aceptaron" },
    { en: "He refused to", es: "Se negó a" },
    { en: "She promised to", es: "Prometió" },
    { en: "They warned us", es: "Nos advirtieron" },
    { en: "He complained about", es: "Se quejó de" },
    { en: "She insisted on", es: "Insistió en" },
    { en: "They denied", es: "Negaron" },
    { en: "He admitted", es: "Admitió" },
    { en: "as far as I understood", es: "según entendí" },
    { en: "to the best of my knowledge", es: "según lo que sé" },
    { en: "word for word", es: "palabra por palabra" },
    { en: "in his own words", es: "en sus propias palabras" },
    { en: "to put it briefly", es: "en resumen" },
    { en: "the gist of it", es: "la idea general" },
    { en: "summary", es: "resumen" },
    { en: "quote (someone)", es: "citar" },
    { en: "paraphrase", es: "parafrasear" },
    { en: "misunderstanding", es: "malentendido" },
    { en: "He claimed", es: "Afirmó" },
    { en: "She alleged", es: "Alegó" },
    { en: "They implied", es: "Insinuaron" },
    { en: "He reiterated", es: "Reiteró" },
    { en: "She acknowledged", es: "Reconoció" },
    { en: "They conceded", es: "Admitieron" },
    { en: "He urged us to", es: "Nos instó a" },
    { en: "She assured me", es: "Me aseguró" },
    { en: "They pledged", es: "Se comprometieron" },
    { en: "He hinted at", es: "Insinuó" },
    { en: "She elaborated on", es: "Amplió sobre" },
    { en: "They disputed", es: "Cuestionaron" },
    { en: "as reported", es: "según lo reportado" },
    { en: "reportedly", es: "supuestamente" },
    { en: "allegedly", es: "presuntamente" },
    { en: "on the record", es: "de forma oficial" },
    { en: "off the record", es: "extraoficialmente" },
    { en: "to take out of context", es: "sacar de contexto" },
    { en: "to misquote", es: "citar mal" },
    { en: "discrepancy", es: "discrepancia" },
    { en: "clarification", es: "aclaración" },
    { en: "rebuttal", es: "refutación" }
  ],
  phrases: [
    { en: "He said he needed it by Friday.", es: 'Dijo que lo necesitaba para el viernes.' },
    { en: "They told me they had sent the samples.", es: 'Me dijeron que habían enviado las muestras.' },
